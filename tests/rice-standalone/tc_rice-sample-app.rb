...
class TravelRequest < Test::Unit::TestCase
  ...
  def test_travel_request
    ...
    puts "Creating sample travel request..."
    assert @app.create_travel_request, "Did not create sample travel request successfully"
